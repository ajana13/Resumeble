              ...
              <div className="card-stacked">
                <div className="card-content">
                  <div className="row">
                    ...
                    <div className="col s12">
                      <h6 className="grey-text">Phone:</h6>
                    </div>
                    <div className="col s12">
                      <p>774-823-0167</p>
                    </div>
                    ...
                    <div className="col s12">
                      <h6 className="grey-text">Adress:</h6>
                    </div>
                    <div className="col s12">
                      <p>151 CommonWealth Ave, Amherst MA</p>
                    </div>

                    <div className="col s12">
                      <h6 className="grey-text">Website:</h6>
                    </div>
                    <div className="col s12">
                      <p>www.hrijo.com</p>
                    </div>
      ...
      <div id="modal2" className="modal">
        <div className="modal-content">
          <div>
            <h4>Upload Resume</h4>
            <p>
              This action is unreversable, click cancel to keep skill or delete
        ...
        <div className="modal-footer">
          ...
          <a href="#!" class="modal-close green white-text btn">
            Save
          </a>
        </div>
      </div>
